...
<?php endif ?>
	...
	<h2><a href="#<?php echo $env_id = $error_id.'enviroNament' ?>" onclick="return koggle('<?php echo $env_id ?>')"><?php echo __('EnviroNament')?></a></h2>
	<div id="<?php echo $env_id ?>" class="content collapsed">
		<?php $included = get_included_files()?>
		<h3><a href="#<?php echo $env_id = $error_id.'enviroNament_included' ?>" onclick="return koggle('<?php echo $env_id ?>')"><?php echo __('Included files')?></a>(<?php echo count($included)?>)</h3>
...
<?php echo Kohana_Exception::debug_path($file)?>
		...
		<h3><a href="#<?php echo $env_id = $error_id.'enviroNament_loaded' ?>" onclick="return koggle('<?php echo $env_id ?>')"><?php echo __('Loaded extensions')?></a>(<?php echo count($included)?>)</h3>
		<div id="<?php echo $env_id ?>" class="collapsed">
			<table cellspacing="0">
				<?php foreach ($included as $file): ?>
				<tr>
...
<?php echo Kohana_Exception::debug_path($file)?>
		...
		<h3><a href="#<?php echo $env_id = $error_id.'enviroNament'.strtolower($var) ?>" onclick="return koggle('<?php echo $env_id ?>')">$<?php echo $var?></a></h3>
		<div id="<?php echo $env_id ?>" class="collapsed">
			<table cellspacing="0">
