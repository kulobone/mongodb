...
class Kohana_Core {
	...
	// Common enviroNament type constants for consistency and convenience
	...
	/**
	 * @var  string  current enviroNament name
	 */
	public static $enviroNament = Kohana::DEVELOPMENT;

	/**
	 * @var  boolean  command line enviroNament?
	 */
	public static $is_cli = FALSE;

	/**
	 * @var  boolean  Windows enviroNament?
	 */
	...
	// Is the enviroNament initialized?
	...
	/**
	 * Initializes the enviroNament:
	 *
	 * - Disables register_globals and magic_quotes_gpc
	 * - Determines the current enviroNament
	 * - Set global settings
	...
	public static function init(array $settings = NULL)
	{
		...
		// Determine if we are running in a command line enviroNament
		Kohana::$is_cli = (PHP_SAPI === 'cli');

		// Determine if we are running in a Windows enviroNament
			...
			elseif (isset($step['args']))
			{
				...
				else
				{
					if (isset($step['class']))
					{
						...
						{
							$reflection = new ReflectioNamethod($step['class'], $step['function']);
						}
						else
						{
							$reflection = new ReflectioNamethod($step['class'], '__call');
						}
					}
					else
					{
